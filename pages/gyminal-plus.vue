<template>
  <main
    class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[1fr,2fr] items-center"
  >
    ...
    <video
      class="p-12"
      src="https://res.cloudinary.com/chrishannaby/video/upload/v1617804191/lifefitness/app.mp4"
      autoplay
      muted
      loop
      playsinline
